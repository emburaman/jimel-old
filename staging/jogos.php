...
if ($_POST['action'] == 'save' && $_POST['id_game'] > 0) {
	...
	echo "<meta http-equiv='refresh' content='0; url=$base_path/jogos.php?h=". $_REQUEST['id_team'] ."'>";
}
elseif ($_POST['action'] == 'save') {
	$u = array(
		...
		$dados = $db->addGame($u);
		echo "<meta http-equiv='refresh' content='0; url=$base_path/jogos.php?h=". $dados ."'>";
}
