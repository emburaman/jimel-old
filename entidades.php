...
if ($_POST['action'] == 'save' && $_POST['id_association'] > 0) {
	...
	echo "<meta http-equiv='refresh' content='0; url=/entidades.php?h=". $_REQUEST['id_association'] ."'>";
}
elseif ($_POST['action'] == 'save') {
	...
	<?php	
		...
		$dados = $db->addTeams($u);
		echo "<meta http-equiv='refresh' content='0; url=/entidades.php?h=". $dados ."'>";
	}
}
...
if ($_POST['action'] == 'del_yes') {
	...
	echo "<meta http-equiv='refresh' content='0; url=/entidades.php'>";
}
